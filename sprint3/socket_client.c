...
int main()
{
	...
	printf("packet sent to server: (header: (version: %u, type: %u, length: %u), payload: %f)\n",
	...
	printf("packet received from server: equal?: %f, (header: (version: %u, type: %u, length: %u), payload: %s)\n",
		   equal,
